...
os.system('root -b -q -l libJetMETCorrectionsModules.so libCondFormatsSerialization.so libcorrectionlib.so libEFTGenReaderEFTHelperUtilities.so libmain.so main.C')
