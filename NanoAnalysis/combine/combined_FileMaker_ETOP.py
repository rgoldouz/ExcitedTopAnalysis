...
Samples = ['data.root','Fake.root', 'Gjets.root','ttG.root',
'TTga_M1700.root',  
'TTga_M1600.root',
'TTga_M1400.root',
'TTga_M1300.root',
...
SamplesNameCombined = ['data_obs','Fake','Gjets','ttG',
'TTga_M1700',  
'TTga_M1600',
'TTga_M1400',
'TTga_M1300',
...
#                Sid1= Samples.index(valueD[1] + '.root')
                T1 = 'max 1 number of categories \n' +\
                     ...
                     '------------\n'+\
                     'bin'.ljust(45) + cardName.ljust(40) + cardName.ljust(40) + cardName.ljust(40) + cardName.ljust(40) +'\n'+\
                     'process'.ljust(45) + '0'.ljust(40) + '1'.ljust(40) + '2'.ljust(40) + '3'.ljust(40) +'\n'+\
                     'process'.ljust(45) + namesig.ljust(40)+ SamplesNameCombined[1].ljust(40) + SamplesNameCombined[2].ljust(40) +\
                     SamplesNameCombined[3].ljust(40) +'\n'+\
                     ...
                     str(Hists[numyear][3][numch][numreg][0].Integral()).ljust(40) + '\n'+\
                     '------------\n'+\
                     'Fake_norm'.ljust(35)+'lnN'.ljust(10)  + '-'.ljust(40)  + '1.5'.ljust(40) + '-'.ljust(40) + '-'.ljust(40) + '\n'+\
