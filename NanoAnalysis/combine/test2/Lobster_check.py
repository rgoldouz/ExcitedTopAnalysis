...
os.system('combine -M  AsymptoticLimits '         +val[0] +'_'+val[1]+'_'+val[2]  + '_com.txt > ' + val[0] +'_'+val[1]+'_'+val[2] +'_results.tex' )
...
os.system('combineTool.py -M Impacts -d '         +val[0] +'_'+val[1]+'_'+val[2] + '_com.root -m 125 --robustFit 1 --doFits --parallel 8 --rMin -3 --rMax 3 -t -1 --expectSignal=1')
