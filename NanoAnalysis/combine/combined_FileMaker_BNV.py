        ...
        for numch, namech in enumerate(channels):
            ...
            for numreg, namereg in enumerate(regions):
                ...
                for numvar, namevar in enumerate(variables):
                    ...
                    QscaleHists=[]
                    nQscaleHists=9
                    if 'Mu' in SignalSamples[f]:
                        nQscaleHists=8
                    nominalHist = TH1EFTtoTH1(sysfile.Get(namech + '_' + namereg + '_' + namevar),wc1)
                    for numsys in range(nQscaleHists):
                    ...
                    for b in range(QscaleHists[0].GetNbinsX()):
                        ...
                        nomRatio = 1
                        for numsys in range(nQscaleHists):
                            if nQscaleHists==8 and (numsys==2 or numsys==5):
                                continue
                            if nQscaleHists==9 and (numsys==2 or numsys==6):
                                continue
                            QS[numsys] = QscaleHists[numsys].GetBinContent(b+1) - nominalHist.GetBinContent(b+1)
                        yerrupQscale.append((abs(max(QS)))*nomRatio)
                        yerrdownQscale.append((abs(min(QS)))*nomRatio)
                        for numsys in range(100):
                            PDF = PDF + (pdfHists[numsys].GetBinContent(b+1) - nominalHist.GetBinContent(b+1))**2
...
if not os.path.exists('CombinedFilesOriginal'):
    ...
    os.system('rm -rf CombinedFilesOriginal/'+ wcName +'_*')
...
for numyear, nameyear in enumerate(year):
    ...
    for numch, namech in enumerate(channels):
        for numreg, namereg in enumerate(regions):
            hfile = ROOT.TFile( 'CombinedFilesOriginal/' + wcName + '_'+ nameyear+'_'+namech+'_'+namereg+'.root', 'RECREATE', 'combine input histograms' )
            for f in range(len(Samples)):
...
SignalSamplesD['TBCMu']=['STBNV_TBCMu','TTBNV_TBCMu']
SignalSamplesD['TBUMu']=['STBNV_TBUMu','TTBNV_TBUMu']
SignalSamplesD['TDCMu']=['STBNV_TDCMu','TTBNV_TDCMu']
SignalSamplesD['TDUMu']=['STBNV_TDUMu','TTBNV_TDUMu']
...
for namesig, valueD in SignalSamplesD.items():
    for numyear, nameyear in enumerate(year):
        for numch, namech in enumerate(channels):
            for numreg, namereg in enumerate(regions):
                cardName = wcName + '_' + namesig+'_'+namech+'_'+nameyear+'_' + namereg
                ...
                T1 = 'max 1 number of categories \n' +\
                     ...
                     '------------\n'+\
                     'shapes * * '  + wcName + '_' + nameyear+'_'+namech+'_'+namereg+'.root' + ' $PROCESS $PROCESS_$SYSTEMATIC\n' +\
                     '------------\n'+\
                     ...
                     'DY_norm'.ljust(35)+'lnN'.ljust(10) + '-'.ljust(40) + '-'.ljust(40) + '-'.ljust(40) + '1.5'.ljust(40) + '-'.ljust(40) + '-'.ljust(40) +'\n'+\
                ...
                if '2016' in nameyear:
                    T1 = T1 + 'lumi2016'.ljust(35)+'lnN'.ljust(10) + '1.022'.ljust(40) + '1.022'.ljust(40) + '1.022'.ljust(40) + '1.022'.ljust(40) + '1.022'.ljust(40) + '1.022'.ljust(40) +'\n'    
                    T1 = T1 + 'lumiXY'.ljust(35)+'lnN'.ljust(10) + '1.009'.ljust(40) + '1.009'.ljust(40) + '1.009'.ljust(40) + '1.009'.ljust(40) + '1.009'.ljust(40) + '1.009'.ljust(40) +'\n'
                    T1 = T1 + 'lumiBBDef'.ljust(35)+'lnN'.ljust(10) + '1.004'.ljust(40) + '1.004'.ljust(40)  + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) +'\n'
                    T1 = T1 + 'lumiDynamicB'.ljust(35)+'lnN'.ljust(10) + '1.005'.ljust(40) + '1.005'.ljust(40)+ '1.005'.ljust(40) + '1.005'.ljust(40) + '1.005'.ljust(40) + '1.005'.ljust(40) +'\n'
                    T1 = T1 + 'lumiGhostS'.ljust(35)+'lnN'.ljust(10) + '1.004'.ljust(40) + '1.004'.ljust(40)  + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) +'\n'
                if '2017' in nameyear:
                    T1 = T1 + 'lumi2017'.ljust(35)+'lnN'.ljust(10) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) +'\n'
                    T1 = T1 + 'lumiXY'.ljust(35)+'lnN'.ljust(10) + '1.008'.ljust(40) + '1.008'.ljust(40) + '1.008'.ljust(40) + '1.008'.ljust(40) + '1.008'.ljust(40) + '1.008'.ljust(40) +'\n'
                    T1 = T1 + 'lumiBBDef'.ljust(35)+'lnN'.ljust(10) + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) + '1.004'.ljust(40) +'\n'
                    T1 = T1 + 'lumiDynamicB'.ljust(35)+'lnN'.ljust(10) + '1.005'.ljust(40) + '1.005'.ljust(40)  + '1.005'.ljust(40) + '1.005'.ljust(40) + '1.005'.ljust(40) + '1.005'.ljust(40) +'\n'
                    T1 = T1 + 'lumiGhostS'.ljust(35)+'lnN'.ljust(10) + '1.001'.ljust(40) + '1.001'.ljust(40) + '1.001'.ljust(40) + '1.001'.ljust(40) + '1.001'.ljust(40) + '1.001'.ljust(40) +'\n'
                    T1 = T1 + 'lumiLengthS'.ljust(35)+'lnN'.ljust(10) + '1.003'.ljust(40) + '1.003'.ljust(40) + '1.003'.ljust(40) + '1.003'.ljust(40) + '1.003'.ljust(40) + '1.003'.ljust(40) +'\n'
                    T1 = T1 + 'lumiBeamCC'.ljust(35)+'lnN'.ljust(10) + '1.003'.ljust(40) + '1.003'.ljust(40)  + '1.003'.ljust(40) + '1.003'.ljust(40) + '1.003'.ljust(40) + '1.003'.ljust(40) +'\n'
                if '2018' in nameyear:
                    ...
                    T1 = T1 + 'lumiXY'.ljust(35)+'lnN'.ljust(10) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) + '1.02'.ljust(40) +'\n'
                    T1 = T1 + 'lumiLengthS'.ljust(35)+'lnN'.ljust(10) + '1.002'.ljust(40)  + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) +'\n'
                    T1 = T1 + 'lumiBeamCC'.ljust(35)+'lnN'.ljust(10) + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) + '1.002'.ljust(40) +'\n'
