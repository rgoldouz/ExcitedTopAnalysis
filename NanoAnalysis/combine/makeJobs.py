...
for namesig in SignalSamples:
    ...
    'combineTool.py -M Impacts -d ' +namesig + '_Combined.root -m 125 --doInitialFit --robustFit 1 -t -1 --expectSignal=1'+ "\n"+\
    'combineTool.py -M Impacts -d ' +namesig + '_Combined.root -m 125 --robustFit 1 --doFits --parallel 8 -t -1 --expectSignal=1'+ "\n"+\
...
#    os.system("qsub -q localgrid  -o STDOUT/" + SHNAME0.split('.')[0] + ".stdout -e STDERR/" + SHNAME0.split('.')[0] + ".stderr Jobs/" + SHNAME0)
    for numyear, nameyear in enumerate(year):
        ...
        'combineTool.py -M Impacts -d ' +namesig + '_' + nameyear + '_llB1.root -m 125 --doInitialFit --robustFit 1 -t -1 --expectSignal=1'+ "\n"+\
        'combineTool.py -M Impacts -d ' +namesig + '_' + nameyear + '_llB1.root -m 125 --robustFit 1 --doFits --parallel 8 -t -1 --expectSignal=1'+ "\n"+\
        'combineTool.py -M Impacts -d ' +namesig + '_' + nameyear + '_llB1.root -m 125 -o impacts.json -t -1 --expectSignal=1'+ "\n"+\
...
#        os.system("qsub -q localgrid  -o STDOUT/" + SHNAME1.split('.')[0] + ".stdout -e STDERR/" + SHNAME1.split('.')[0] + ".stderr Jobs/" + SHNAME1)
        ...
        'combineTool.py -M Impacts -d ' +namesig + '_' + nameyear + '_com.root -m 125 --doInitialFit --robustFit 1 -t -1 --expectSignal=1'+ "\n"+\
        'combineTool.py -M Impacts -d ' +namesig + '_' + nameyear + '_com.root -m 125 --robustFit 1 --doFits --parallel 8 -t -1 --expectSignal=1'+ "\n"+\
        'combineTool.py -M Impacts -d ' +namesig + '_' + nameyear + '_com.root -m 125 -o impacts.json -t -1 --expectSignal=1'+ "\n"+\
