...
//    std::cout << "--- TMVAClassification       : Using input file: " << input->GetName() << std::endl;
    ...
    inputB = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/ExcitedTopAnalysis/analysis/hists/2017_GJetsHT600ToInf.root" );
    inputS = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/ExcitedTopAnalysis/analysis/hists/2017_tptpM1000.root" );
    TTree *signalTree     = (TTree*)inputS->Get("TStar");
    TTree *background     = (TTree*)inputB->Get("TStar");
    ...
    dataloader->AddVariable( "MVA_Ph_pt",                "photon pt", "GeV", 'F' );
    dataloader->AddVariable( "MVA_Ph_eta",               "photon eta", "", 'F' );
    dataloader->AddVariable( "MVA_Ak8_pt",               "Ak8 jet pt", "GeV", 'F' );
    dataloader->AddVariable( "MVA_Ak8_eta",              "Ak8 jet eta", "", 'F' );
    dataloader->AddVariable( "MVA_Ak8_Mass",             "Ak8 jet mass", "GeV", 'F' );
//    dataloader->AddVariable( "MVA_Ak8_TvsQCD",              "Ak8 jet TvsQCD", "", 'F' );
    dataloader->AddVariable( "MVA_Ak8_Nbsub",              "Ak8 jet Nbsub", "", 'F' );
    dataloader->AddVariable( "MVA_Ak8_N",              "Ak8 jet N", "", 'F' );
//    dataloader->AddVariable( "MVA_Ak8_NtopTag",              "Ak8 jet N top tag", "", 'F' );
    dataloader->AddVariable( "MVA_Ak4_N",              "Ak4 jet N", "", 'F' );
    dataloader->AddVariable( "MVA_Ak4_pt",               "Ak4 jet pt", "GeV", 'F' );
    dataloader->AddVariable( "MVA_Ak4_eta",              "Ak4 jet eta", "", 'F' );
    dataloader->AddVariable( "MVA_Ak4_HT",             "Ak4 jet HT", "GeV", 'F' );
